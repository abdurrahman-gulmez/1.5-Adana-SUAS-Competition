...
if tf_version.startswith('2.'):  # TensorFlow 2.x için
    try:
        # TensorFlow 2.15.1'de resmi yol
        from official.vision.image_classification.efficientnet import efficientnet_model
    except ModuleNotFoundError:
        try:
            # Eski sürümler için alternatif yol
            from official.legacy.image_classification.efficientnet import efficientnet_model
        except ModuleNotFoundError:
            raise ImportError("EfficientNet modeli bulunamadı. 'official' modülü doğru şekilde kurulu mu?")
else:
    raise ImportError("Bu kod yalnızca TensorFlow 2.x sürümleriyle çalışır.")
